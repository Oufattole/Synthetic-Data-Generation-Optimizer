...
Synthetic Data Generation Optimizer could always use more documentation, whether as part of the
official Synthetic Data Generation Optimizer docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
Ready to contribute? Here's how to set up `Synthetic Data Generation Optimizer` for local development.

1. Fork the `Synthetic Data Generation Optimizer` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/synthetic-data-generation-optimizer.git

3. Install your local copy into a virtualenv. Assuming you have virtualenvwrapper installed,
   this is how you set up your fork for local development::

    $ mkvirtualenv synthetic-data-generation-optimizer
...
2. The tests that cover a module called ``synthetic_data_generation_optimizer/path/to/a_module.py``
   should be implemented in a separated module called
   ``tests/synthetic_data_generation_optimizer/path/to/test_a_module.py``.
...
To run a subset of tests::
    ...
    $ python -m pytest tests.test_synthetic_data_generation_optimizer
...
2. Update the version in ``setup.cfg``, ``synthetic_data_generation_optimizer/__init__.py`` and
   ``HISTORY.md`` files.
3. Create a new git tag pointing at the corresponding commit in ``stable`` branch.
4. Merge the new commit from ``stable`` into ``master``.
5. Update the version in ``setup.cfg`` and ``synthetic_data_generation_optimizer/__init__.py``
...
dependency specification, either in ``setup.py``::
    ...
    install_requires = [
        ...
        'synthetic-data-generation-optimizer>=X.Y.Z.dev',
        ...
    ]

or in command line::

    pip install 'synthetic-data-generation-optimizer>=X.Y.Z.dev'


.. _GitHub issues page: https://github.com/oufattole/synthetic-data-generation-optimizer/issues
.. _Build Status page: https://github.com/oufattole/synthetic-data-generation-optimizer/actions
